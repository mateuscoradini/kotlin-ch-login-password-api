...
class PasswordValidatorTest {
    ...
    inner class ValidateMethod {
        ...
        @Test
        fun `validate - should aggregate violations from every rule that is not satisfied`() {
            ...
            result.violations `should contain same` listOf(RuleViolation.NO_DIGIT, RuleViolation.MIN_LENGTH)
        }
